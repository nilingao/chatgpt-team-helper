...
import { AlertTriangle, ClipboardCopy, Cookie as CookieIcon, Loader2, PenSquare, RefreshCw, Timer, Trash2, ChevronLeft, ChevronRight, Search, X } from 'lucide-vue-next'
              ...
              >
                ...
                <td class="px-6 py-5 text-right">
                  <div class="flex items-center justify-end gap-1">
                    ...
                    <Button size="icon" variant="ghost" class="h-8 w-8 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg" @click="copyOrderNumber(order.orderNumber)">
